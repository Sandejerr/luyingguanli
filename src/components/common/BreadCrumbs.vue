<template>
  <el-breadcrumb class="app-breadcrumb" separator="<<" style="height:50px;backgroundColor:var(--publicMainColor);borderRadius:0;padding:0;boxShadow:0px 0px 0px var(--publicMainColor);borderWidth:0px 0px 0px 0px;borderStyle:dotted;borderColor:var(--publicMainColor);">
