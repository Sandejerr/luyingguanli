    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">露营地管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="初级管理姓名" class="input" v-if="tableName=='chujiguanli'">
                            <el-input v-model="ruleForm.chujiguanliName" autocomplete="off" placeholder="初级管理姓名"  />
                        </el-form-item>
                        <el-form-item label="初级管理手机号" class="input" v-if="tableName=='chujiguanli'">
                            <el-input v-model="ruleForm.chujiguanliPhone" autocomplete="off" placeholder="初级管理手机号"  />
                        </el-form-item>
                        <el-form-item label="初级管理身份证号" class="input" v-if="tableName=='chujiguanli'">
                            <el-input v-model="ruleForm.chujiguanliIdNumber" autocomplete="off" placeholder="初级管理身份证号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='chujiguanli'">
                            <el-input v-model="ruleForm.chujiguanliEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.chujiguanliName)&& 'chujiguanli'==this.tableName){
                                this.$message.error('初级管理姓名不能为空');
                                return
                            }
                             if('chujiguanli' == this.tableName && this.ruleForm.chujiguanliPhone&&(!this.$validate.isMobile(this.ruleForm.chujiguanliPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.chujiguanliIdNumber)&& 'chujiguanli'==this.tableName){
                                this.$message.error('初级管理身份证号不能为空');
                                return
                            }
                            if('chujiguanli' == this.tableName && this.ruleForm.chujiguanliEmail&&(!this.$validate.isEmail(this.ruleForm.chujiguanliEmail))){
...
<style lang="scss" scoped>
    ...
    .container {
        ...
        background-image: url(/luyingdiguanlixitong/img/back-img-bg.jpg);
